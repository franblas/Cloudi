...
<?php 
//ecriture rate pour application
$req = $bdd->prepare("INSERT INTO rateActualite2 (nomcommande, note, utilisateur) VALUES(?, ?, ?)");
$req->execute(array($_POST['actuactu'],$_POST['rateactu'],$_SESSION['login']));
