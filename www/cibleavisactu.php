...
<?php 
//Insertion Message
$req = $bdd->prepare("INSERT INTO avisActualite (nomcommande, avis, utilisateur) VALUES(?, ?, ?)");
$req->execute(array($_POST['nomactu'],$_POST['avisactu'],$_SESSION['login']));

//Redirection vers le minichat
$_SESSION['descactu']=$_POST['nomactu'];
header("Location: actudescription.php");
?>
