...
<!-- Menu store applications -->
<fieldset>
<legend id="legendvirtu">Store Applications</legend>
<!-- AutoCompletion Applications -->
 <script type="text/javascript" src="autocomplete.js"></script>
<script type="text/javascript">
window.onload = function(){initAutoComplete(document.getElementById('form-test'),
document.getElementById('descappli'),document.getElementById('bouton-submit'))};
</script>
<center><form name="form-test" id="form-test" method='post' action="cibleapplidescription.php" style="margin:10px;display:inline-block;">
<input type="search" name="descappli" id="descappli" size="20" placeholder='Recherche' autocomplete="off" style='font-size:22px;width:150%;border: 1px solid grey;'/>
...
<div id='divapp<?php echo $donnees['nomcommande']; ?>' style='background:#fff;border-radius:5px 5px 0px 0px;box-shadow:3px 3px 3px grey;'>
<form style="display:inline;margin:10px;" action="cibleapplidescription.php" method="post">
<input type="hidden" value="<?php echo $donnees['nomcommande']; ?>" name="descappli" class="text">
<input type="image" src="/images/<?php echo $donnees['nomcommande']; ?>.png" width="90" height="90" style='margin-top:10px;' onMouseOver="document.getElementById('divapp<?php echo $donnees['nomcommande']; ?>').style.opacity='0.6';this.style.opacity='0.6';document.getElementById('divapp<?php echo $donnees['nomcommande']; ?>').style.boxShadow='3px 0px 3px grey';" onMouseOut="document.getElementById('divapp<?php echo $donnees['nomcommande']; ?>').style.opacity='1';this.style.opacity='1';document.getElementById('divapp<?php echo $donnees['nomcommande']; ?>').style.boxShadow='3px 3px 3px grey';">
</form>
</div>
