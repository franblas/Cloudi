...
$req->execute(array($_SESSION['login'], $_POST['champ-texte'], $_POST['message'], 0, date("F j, Y, g:i a")));

//Redirection vers le minichat
$_SESSION['msgfrom']=$_POST['champ-texte'];
$_SESSION['message2']=$_POST['message'];
header("Location: minichat_recup2.php");
?>
