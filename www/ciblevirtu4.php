...
$req = $bdd->prepare("UPDATE tableActualite SET $session2 = :newres WHERE nomcommande = :nameactu");
$req->execute(array('newres' => '0','nameactu' => $_POST['actu']));

//Redirection la page actualite
